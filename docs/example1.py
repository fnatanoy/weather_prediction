...
model = Sequential()
model.add(Convolution1D(input_shape=(examples, features),filters=2, kernel_size=3))
...
# Train
hist = model.fit(input_mat, target_mat, epochs=100, batch_size=100, validation_split=0.05, show_accuracy=False)
